...
#    Updated: 2019/02/07 02:56:03 by conoel           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = push_swap_quick
NAME2 = checker
...
all: $(LIBFT) $(OBJDIR) $(OBJ_NOFlAG) $(NAME) $(NAME2)
...
$(NAME)_noflag: $(LIBFT) $(OBJDIR) $(OBJ_NOFLAG) $(OBJDIR)$(NAME)noflag.o
	@clang $(OBJ) ./obj/$(NAME)noflag.o -o $(NAME) $(LIBFT)
	@echo "\n    /-------========= ~~ * ~~ =========-------\ \n      \033[34m\033[1m$(NAME) noflag binary created successfully !\033[0m\n    \-------========= ~~ * ~~ =========-------/\n"

$(NAME2)_noflag: $(LIBFT) $(OBJDIR) $(OBJ_NOFLAG) $(OBJDIR)$(NAME2)noflag.o
	@clang $(OBJ) ./obj/$(NAME2)noflag.o -o $(NAME2) $(LIBFT)
